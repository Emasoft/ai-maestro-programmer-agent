...
description: Identify the project programming language
...
This operation identifies the primary programming language of a project by
examining files, directory structure, and configuration files.
...
Look for language-specific configuration files at the project root. These are
