...
> **First-time project setup?** If this is your first time working on this
> project, use the `ampa-project-setup` skill instead — it provides
> comprehensive environment initialization including language detection,
> linting, and testing framework setup. This operation is for subsequent tasks
