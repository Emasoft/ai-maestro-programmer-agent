...
- **[op-clone-repository.md](references/op-clone-repository.md)** -- Cloning and
  forking
- **[op-create-feature-branch.md](references/op-create-feature-branch.md)** --
  Branch creation
- **[op-commit-changes.md](references/op-commit-changes.md)** -- Staging and
  committing
- **[op-create-pull-request.md](references/op-create-pull-request.md)** -- PR
  creation
- **[op-respond-to-review.md](references/op-respond-to-review.md)** -- Handling
  review feedback
- **[op-update-pr-with-fixes.md](references/op-update-pr-with-fixes.md)** --
  Pushing fixes after rejection
